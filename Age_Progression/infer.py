...
parser.add_argument('--image_dir', default='D:\\Fast-AgingGAN-master\\UTKface_inthewild\\images', help='The image directory')
...
def main():
    ...
    trans = transforms.Compose([
        transforms.Resize((1000, 612)),
        transforms.ToTensor(),
        transforms.Normalize(mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5))
    ])
    fig, ax = plt.subplots(2, 6, figsize=(30, 40))
