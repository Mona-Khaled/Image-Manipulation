...
DATASET_PARAMETERS = {
    ...
    # voice dataset
    'voice_dir': 'E:\Flairstech/fbank',
    'voice_ext': 'npy',

    # face dataset
    'face_dir': 'E:\Flairstech/VGG_ALL_FRONTAL',
    'face_ext': '.jpg',
    ...
    # test data
    'test_data': 'C:/Users/HP/OneDrive/Desktop/front GP/voices'
}
...
NETWORKS_PARAMETERS = {
    ...
    'f': {
        ...
        'output_channel': 64,
        'model_path': 'pretrained_models/face_embedding.pth',
    },
    # DISCRIMINATOR (d)
    'd': {
